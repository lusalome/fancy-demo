...
public class MyScheduledExecutorService {
    ...
    public static void main(String[] args) {
        ...
        // 1秒钟后运行，并每隔2秒运行一次
        final ScheduledFuture beeperHandle1 = scheduledExecutorService.scheduleAtFixedRate(beeper, 1, 2, TimeUnit.SECONDS);

        // 2秒钟后运行，并每次在上次任务运行完后等待5秒后重新运行
        final ScheduledFuture beeperHandle2 = scheduledExecutorService.scheduleWithFixedDelay(beeper, 2, 5, TimeUnit.SECONDS);
